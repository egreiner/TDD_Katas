-> https://ccd-school.de/en/coding-dojo/function-katas/rot-13/
...
Example:
Hello, World -> URYYB, JBEYQ										DONE

An „e“ gets to an „R“ and a „W“ gets to a „J“. Lower case letters are translated to upper case.

German “Umlaute” need to be replaced by the following character combinations before the coding: 
„Ö“ = „OE“, „Ä“ = „AE“, „Ü“ = „UE“, „ß“ = „SS“.						DONE

Characters that are no letters are not encoded.						DONE

Variation #1
The offset (13 in this case) should be variable.					DONE (not tested)

Variation #2
Encode digits also. Digits and letters should form a unit: 0123456789ABCDEFGH…XYZ.
With offset 13 the „0“ gets to a „D“ and a „Z“ doesn’t get to an „M“ but to a „C“.		DONE
